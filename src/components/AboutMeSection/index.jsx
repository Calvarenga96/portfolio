    ...
    <Box mt={0}>
      ...
      <Box mt={5}>
        <Text color="whiteColor">
          I was interested in technology from an early age thanks to the
          influence of my parents, but it wasn't until 2020, that I really
          started studying in online platforms like{" "}
          <Link
          ...
          didn't manage to grab me like programming. Currently, I started
          studying{" "}
          <Link
