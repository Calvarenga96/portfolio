        ...
        >
            ...
            <Box mt={5}>
                <Text color="whiteColor">
                    ...
                    {lang === "en"
                        ? ". Before that, I have studied and worked in other fields such as Graphic Design and Digital Marketing, which gives me a certain facility to work with teams from other areas, but it was discovering programming that captivated me and has been my passion to this day. "
                        : ". Antes de eso, he estudiado y trabajado en otras ramas como Diseño Gráfico y Marketing Digital, lo cuál me da cierta facilidad para trabajar con equipos de otras áreas, aunque descubrir la programación fue lo que me cautivó y apasionó hasta hoy en día. "}
                </Text>
                <Text color="whiteColor">
                    {lang === "en"
